...
const navItems = [
  { href: '/dashboard/supplier', label: 'Overview' },
  { href: '/dashboard/supplier/inventory', label: 'Inventory' },
  { href: '/dashboard/supplier/add-batch', label: 'Add Batch' },
  { href: '/dashboard/supplier/batches', label: 'My Batches' },
  { href: '/dashboard/supplier/stock-alerts', label: 'Stock Alerts' },
  { href: '/dashboard/supplier/transactions', label: 'Transactions' },
  { href: '/dashboard/supplier/profile', label: 'Profile' },
]
...
export default function SupplierLayout({ children }: { children: React.ReactNode }) {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center text-slate-600">Loading supplier workspace...</div>
  }
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 pb-1 pt-4">
        ...
        <Link href="/dashboard/supplier/add-batch" className="rounded-md bg-[#8EC641] px-3 py-2 text-xs font-semibold text-white hover:bg-[#79ae35]">
          Receive New Batch
        </Link>
      </div>
